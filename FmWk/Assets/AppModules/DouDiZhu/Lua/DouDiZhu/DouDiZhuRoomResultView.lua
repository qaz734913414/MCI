ClassView(PanelNames.DouDiZhuRoomResultView, GameNames.DouDiZhu, UILayer.PanelHigh)

function DouDiZhuRoomResultView:OnCreate()
...
function DouDiZhuRoomResultView:UpDataView()
...
function DouDiZhuRoomResultView:ExitButtClick()
	CtrlManager.GetCtrl(CtrlNames.DouDiZhuMain):OnCallExitGame()
    CtrlManager.CloseCtrl(CtrlNames.DouDiZhuRoomResult)
end

function DouDiZhuRoomResultView:DetailsClick()
	CtrlManager.ReOpenCtrl(GameNames.DouDiZhu,CtrlNames.DouDiZhuGameResult)
	CtrlManager.CloseCtrl(CtrlNames.DouDiZhuRoomResult)
end

function DouDiZhuRoomResultView:ShareToCircle()
